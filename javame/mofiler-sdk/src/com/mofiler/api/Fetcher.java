...
public class Fetcher
{
    ...
    private MO_Device moDevice = null;
    ...
    public void setMODeviceObject(MO_Device modev)
    {
        this.moDevice = modev;
    }
...
//                } /* end while */
    ...
    private JSONObject buildDeviceContextJSONObject()
    {
    	...
    	try {
        	...
        	jsonobjInner.put(Constants.K_MOFILER_API_DEVICE_CONTEXT_DISPLAYSIZE, moDevice.getDisplaySize());
